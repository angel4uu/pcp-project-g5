"""
Este script implementa un pipeline de inferencia de rostros estrictamente secuencial
que se ejecuta exclusivamente en el procesador central (CPU).

Características del Flujo:
1.  Ejecución Secuencial:
    - Todas las etapas del pipeline (Captura, Preprocesamiento, Inferencia,
      Postprocesamiento y Visualización) se ejecutan en estricto orden, una tras otra.
    - El Frame N debe terminar todo el ciclo antes de que el Frame N+1 pueda comenzar.
2.  Uso Exclusivo de CPU:
    - Tanto el modelo de YOLO como los datos son cargados y procesados enteramente
      por la CPU.
"""
