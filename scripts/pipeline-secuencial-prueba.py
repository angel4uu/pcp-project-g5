...
def postprocesar(frame, results):
    ...
    for box in results.boxes:
        # Mover tensores a la CPU con .cpu() --- REVISAR SI USAS CUDA
...
def visualizar(frame):
    cv2.imshow("Deteccion Secuencial", frame)
...
def ejecutar_pipeline(video_path, model_path):
    ...
    while True:
        ...
        #torch.cuda.synchronize()  --- REVISAR SI USAS CUDA
    ...
    print("\n=== RESULTADOS SECUENCIALES (usando CPU) ===")
